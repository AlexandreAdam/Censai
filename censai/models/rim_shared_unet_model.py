...
class SharedUnetModel(tf.keras.Model):
    ...
    def __call__(self, source, kappa, source_grad, kappa_grad, states, training=True):
        return self.call(source, kappa, source_grad, kappa_grad, states, training=training)
    ...
    def call(self, source, kappa, source_grad, kappa_grad, states, training=True):
        ...
        delta_xt = self.bottleneck_layer1(delta_xt, training=training)
        delta_xt = self.bottleneck_layer2(delta_xt, training=training)
