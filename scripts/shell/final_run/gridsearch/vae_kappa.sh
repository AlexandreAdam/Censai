...
python $CENSAI_PATH/scripts/experiments/vae_kappa_gridsearch.py\
  --datasets $CENSAI_PATH/data/hkappa512_TNG100_trainset/ $CENSAI_PATH/data/hkappa512_TNG100_trainset/\
  ...
  --staircase\
  --beta_init 0.1\
  --beta_end_value 0.3 0.4 0.5 0.6 0.7 0.8\
  --beta_decay_power 1\
  --beta_decay_steps 10000 50000 100000\
  --beta_cyclical 0\
  ...
  --logdir=$CENSAI_PATH/logsVAEhk512\
