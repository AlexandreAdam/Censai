...
#SBATCH --job-name=Train_RIM_SharedUnetv5_FR128hst
#SBATCH --output=%x-%j.out
source $HOME/environments/censai3.8/bin/activate
python $CENSAI_PATH/scripts/experiments/rim_shared_attunetv5_gridsearch.py\
  ...
  --logname_prefixe=RIMSAU128hstv5_augmented\
