...
#SBATCH --job-name=Train_RIM_SourceUnetv3_FR128hst
#SBATCH --output=%x-%j.out
source $HOME/environments/censai3.8/bin/activate
python $CENSAI_PATH/scripts/experiments/rim_shared_unetv3_source_gridsearch.py\
  ...
  --logname_prefixe=RIMSource128hstv3_control\
