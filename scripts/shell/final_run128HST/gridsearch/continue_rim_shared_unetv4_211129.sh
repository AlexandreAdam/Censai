...
python $CENSAI_PATH/scripts/experiments/continue_rim_shared_unetv4.py\
  ...
  --models \
  RIMSU128hstv4_augmented_007_RMSP0_TS8_F32_TWquadratic_KRWsqrt_211124134229\
  RIMSU128hstv4_augmented_006_RMSP0_TS8_F32_TWquadratic_KRWuniform_211124134229\
  --forward_method=fft\
  --epochs=200\
  --max_time=47\
  --optimizer ADAMAX\
