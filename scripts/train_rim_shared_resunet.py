...
import numpy as np
import math
from censai import PhysicalModel, RIMSharedResUnet
from censai.models import SharedResUnetModel, RayTracer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--logname_prefixe",         default="RIMRSU",              help="If name of the log is not provided, this prefix is prepended to the date")
