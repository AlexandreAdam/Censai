...
import numpy as np
import math
from censai import PhysicalModel, RIMSharedMemoryResAtrous
from censai.models import SharedMemoryResUnetAtrousModel, RayTracer
...
def main(args):
    ...
    unet = SharedMemoryResUnetAtrousModel(
        ...
        psp_output=args.psp_output,
        psp_scaling=args.psp_scaling
    )
    rim = RIMSharedMemoryResAtrous(
        physical_model=phys,
        unet=unet,
        steps=args.steps,
        adam=args.adam,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--logname_prefixe",         default="RIMSMRUA",            help="If name of the log is not provided, this prefix is prepended to the date")
