...
from scripts.train_rim_shared_memory_resunet_atrous import main
import copy
import pandas as pd
...
if __name__ == '__main__':
    ...
    parser.add_argument("--psp_output",                                 default=1, nargs="+", type=int)
    parser.add_argument("--psp_bottleneck",                             default=1, nargs="+", type=int)
