...
PARAMS_NICKNAME = {
    ...
    "dropout_rate": "D",
    "gru_architecture": "GA",
    "decoding_blurpool": "DBP",
    "blurpool_kernel_size": "BPKS",
...
if __name__ == '__main__':
    ...
    parser.add_argument("--blurpool_kernel_size",                       default=5,      type=int, nargs="+")
    parser.add_argument("--decoding_blurpool",                          default=0,      type=int, nargs="+")
