...
from scripts.train_kappa_vae_second_stage import main
import copy
import pandas as pd
...
if __name__ == '__main__':
    ...
    # Model params
    parser.add_argument("--hidden_layers",          default=4,      nargs="+",   type=int,       help="Number of layer in encoder/decoder")
    ...
    parser.add_argument("--units",                  default=32,     nargs="+",   type=int,       help="Number of hidden unit in MLP layers")
